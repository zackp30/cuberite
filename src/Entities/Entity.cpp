...
void cEntity::BroadcastMovementUpdate(const cClientHandle * a_Exclude)
{
	...
	if (GetWorld()->GetWorldAge() % 2 == 0)
	{
		...
		int DiffX = (int)(floor(GetPosX() * 32.0) - floor(m_LastSentPosition.x * 32.0));
		int DiffY = (int)(floor(GetPosY() * 32.0) - floor(m_LastSentPosition.y * 32.0));
		int DiffZ = (int)(floor(GetPosZ() * 32.0) - floor(m_LastSentPosition.z * 32.0));
